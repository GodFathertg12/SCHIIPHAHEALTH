  ...
  return (
    <main className="max-w-3xl mx-auto my-12 bg-white text-gray-800 p-6 rounded-lg shadow overflow-y-auto h-[80vh]">
      ...
      <div className="space-y-6 text-base leading-relaxed">
        <p>
          At Schiipha, your privacy and trust are very important to us. This
          Privacy Policy explains how we collect, use, store, and protect your
          personal information in accordance with the Nigeria Data Protection
        ...
        <ul className="list-disc ml-6">
          ...
          <li>Device & Usage Data: Information automatically collected when you visit our website, such as IP address, browser type, and browsing activity.</li>
